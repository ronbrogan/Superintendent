...
// Change to main and change type in project properties -> Linker -> System
int oldmain()
{
...
// Change to wWinMain and change type in project properties -> Linker -> System
    ...
    _In_ int       nCmdShow)
{
    ...
    HWND window = CreateWindowExA(0, TITLE, TITLE, WS_POPUP | WS_VISIBLE, 320, 240, 640, 480, nullptr, nullptr, nullptr, nullptr);
